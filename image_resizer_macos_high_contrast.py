"""
Image Resizer - macOS High Contrast Compatible Version
Uses system colors and ensures visibility on all Mac desktop themes
"""
...
class ImageResizerApp:
    ...
    def setup_ui(self):
        """Setup the user interface with high contrast compatibility"""
        
        # Force update to ensure GUI renders
        self.root.update_idletasks()
        
        # HEADER - Use system colors for high contrast compatibility
        header_frame = tk.Frame(self.root, relief=tk.RAISED, bd=3, bg="navy")
        ...
        # Left panel - Controls
        left_panel = tk.Frame(main_container, padx=10, pady=10, relief=tk.RAISED, bd=2)
        left_panel.pack(side=tk.LEFT, fill=tk.BOTH, expand=False)
        
        # Right panel - Preview
        right_panel = tk.Frame(main_container, padx=10, pady=10, bg="lightgray", relief=tk.SUNKEN, borderwidth=3)
        ...
        footer_frame = tk.Frame(self.root, relief=tk.RAISED, bd=3, bg="darkgray")
    ...
    def setup_controls(self, parent):
        """Setup the control panel with high contrast colors"""
        
        # Upload section
        upload_frame = tk.LabelFrame(parent, text="📁 Upload Image", font=("Arial", 11, "bold"), padx=10, pady=10, relief=tk.RAISED, bd=2)
        upload_frame.pack(fill=tk.X, pady=(0, 15))
        
        self.file_label = tk.Label(upload_frame, text="No file selected", fg="red", font=("Arial", 10, "bold"))
        ...
        self.info_label = tk.Label(self.info_frame, text="Upload an image to see details", fg="blue", justify=tk.LEFT, font=("Arial", 10, "bold"))
    ...
    def setup_preview_panel(self, parent):
        """Setup the preview panel with high contrast visibility"""
        ...
        canvas_frame = tk.Frame(parent, bg="lightgray")
