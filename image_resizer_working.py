#!/usr/bin/env python3
"""
Image Resizer - Working Version for macOS
Uses simple, reliable layout that renders properly
"""
...
class ImageResizerApp:
    ...
    def setup_ui(self):
        """Setup the user interface with simple, reliable layout"""
    ...
    def setup_controls(self, parent):
        ...
        # Dimensions section
        dim_frame = tk.LabelFrame(parent, text="⚙️ Resize Settings", font=("Arial", 11, "bold"), padx=10, pady=10)
        ...
        tk.Label(width_frame, text="Width:", font=("Arial", 10, "bold")).pack(side=tk.LEFT, padx=5)
        width_entry = tk.Entry(width_frame, textvariable=self.width_var, width=10, font=("Arial", 10))
        width_entry.pack(side=tk.LEFT, padx=5)
        width_entry.bind('<KeyRelease>', self.on_width_change)
        
        tk.Label(width_frame, text="px", font=("Arial", 10, "bold")).pack(side=tk.LEFT, padx=5)
        
        height_frame = tk.Frame(dim_frame)
        height_frame.pack(fill=tk.X, pady=5)
        
        tk.Label(height_frame, text="Height:", font=("Arial", 10, "bold")).pack(side=tk.LEFT, padx=5)
        height_entry = tk.Entry(height_frame, textvariable=self.height_var, width=10, font=("Arial", 10))
        height_entry.pack(side=tk.LEFT, padx=5)
        height_entry.bind('<KeyRelease>', self.on_height_change)
        
        tk.Label(height_frame, text="px", font=("Arial", 10, "bold")).pack(side=tk.LEFT, padx=5)
        ...
        # Quality section
        quality_frame = tk.LabelFrame(parent, text="🎚️ Quality Settings", font=("Arial", 11, "bold"), padx=10, pady=10)
        ...
        tk.Label(preset_frame, text="Quick presets:", font=("Arial", 9, "bold")).pack(side=tk.LEFT, padx=(0, 10))
...
def main():
    print("Starting Image Resizer - Working Version...")
    ...
    try:
        ...
        print("This version uses simple, reliable layout that should render properly")
